...
import de.team33.libs.exceptional.v4.UncheckedEnvelope;
import de.team33.libs.exceptional.v4.UncheckedWrapper;
...
public class UncheckedWrapperTest<X extends RuntimeException> {

    private final Class<X> runtimeExceptionType;
    private final UncheckedWrapper<X> wrapper;

    public UncheckedWrapperTest(final Class<X> runtimeExceptionType, final UncheckedWrapper<X> wrapper) {
    ...
    public static Iterable<Object[]> data() {
        return Arrays.asList(new Object[][]{
                {UncheckedEnvelope.class, UncheckedWrapper.DEFAULT},
                {IllegalStateException.class, new UncheckedWrapper<>(IllegalStateException::new)},
                {RuntimeException.class, new UncheckedWrapper<>(RuntimeException::new)}
        });
    }
