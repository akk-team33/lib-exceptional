...
public class WrapperTest<X extends RuntimeException> {
    ...
    private final Wrapper<X> wrapper;

    public WrapperTest(final Class<X> runtimeExceptionType, final Wrapper<X> wrapper) {
    ...
    public static Iterable<Object[]> data() {
        return Arrays.asList(new Object[][]{
                {WrappedException.class, Wrapper.DEFAULT},
                {IllegalStateException.class, new Wrapper<>(IllegalStateException::new)},
                {RuntimeException.class, new Wrapper<>(RuntimeException::new)}
        });
    }
